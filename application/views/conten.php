														...
														<div id="member-tab" class="tab-pane">
															<div class="clearfix">
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="http://localhost:8000/AdminElib/assets/img/user.jpg">
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Joe Doe's avatar" src="http://localhost:8000/AdminElib/assets/img/avatar2.png">
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Jim Doe's avatar" src="http://localhost:8000/AdminElib/assets/img/avatar.png">
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alex Doe's avatar" src="http://localhost:8000/AdminElib/assets/img/avatar5.png">
																	</div>
